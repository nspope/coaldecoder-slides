...
![](fig/pair-coal-rates/model.png){.fragment .current-visible}

![](fig/pair-coal-rates/rates-0.png){.fragment .current-visible}

![](fig/pair-coal-rates/rates-1.png){.fragment .current-visible}

![](fig/pair-coal-rates/rates-2.png){.fragment .current-visible}

![](fig/pair-coal-rates/rates-3.png){.fragment .current-visible}

![](fig/pair-coal-rates/rates-smooth.gif){.fragment .current-visible}

![](fig/pair-coal-rates/rates-optim.gif){.fragment .current-visible}
