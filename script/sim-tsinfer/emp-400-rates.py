...
if not os.path.exists(rate_store) or force_overwrite:
    ...
    pickle.dump(trio_rates_dbg, open("debug.p", "wb"))
else:
...
plt.savefig(output_dir + "emp-pair-200-2.png")
...
plt.savefig(output_dir + "emp-pair-200-3.png")
emoji.remove()
...
plt.savefig(output_dir + "emp-pair-200-4.png")
...
plt.savefig(output_dir + "emp-pair-200-5.png")
